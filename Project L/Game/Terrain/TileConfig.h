...
struct TileConfig
{
	...
	static Vec2 getMinUvFromTileType(TILE_TYPE type)
	{
		switch (type)
		{
			...
			case TILE_STONE_3:			return Vec2(MIN_UV(0, 8)); break;
...
#define ENUM_TO_STR_CASE_RETURN(mask) case mask: return #mask; break;
#define MASK_TO_STR(mask) #mask;
	static std::string getStrFromMask(TILE_MASK mask)
	{
		switch (mask)
		{
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_TL)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_TR)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_BL)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_BR)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_T)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_L)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_R)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_B)

			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FILLED_TL)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FILLED_TR)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FILLED_BL)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FILLED_BR)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FILLED_T)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FILLED_L)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FILLED_R)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FILLED_B)

			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_SOLO)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_SOLO_T)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_SOLO_B)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_SOLO_L)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_SOLO_R)

			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_TUBE_BLOCKED_V)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_TUBE_BLOCKED_H)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_TUBE_V)
			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_TUBE_H)

			ENUM_TO_STR_CASE_RETURN(MASK_PATCH_FULL)
			ENUM_TO_STR_CASE_RETURN(MASK_EMPTY)
	...
	static std::string getStrFromType(TILE_TYPE mask)
	{
		switch (mask)
		{
			ENUM_TO_STR_CASE_RETURN(TILE_WIRE_FRAME)
			ENUM_TO_STR_CASE_RETURN(TILE_SKY)
			ENUM_TO_STR_CASE_RETURN(TILE_GRASS)
			ENUM_TO_STR_CASE_RETURN(TILE_DIRT)
			ENUM_TO_STR_CASE_RETURN(TILE_STONE)
			ENUM_TO_STR_CASE_RETURN(TILE_STONE_2)
			ENUM_TO_STR_CASE_RETURN(TILE_STONE_GOLD)
			ENUM_TO_STR_CASE_RETURN(TILE_STONE_3)
			ENUM_TO_STR_CASE_RETURN(TILE_EMPTY)
			default: return "UNKNOWN";
		}
	}
